...
- **Observability & audit** — correlation/execution IDs and metrics; a durable, owner-scoped **audit trail** of agent decisions, guardrail outcomes, confirmations, and tool executions (three typed PostgreSQL tables, read via `GET /api/v1/agent/executions`) — _implemented (M9)_. Dashboards are _planned (M10)_.
